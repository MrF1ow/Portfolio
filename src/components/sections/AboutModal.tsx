  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 bg-dark text-dark-text w-full max-w-4xl h-[520px] flex animate-in overflow-hidden" style={{ animationDuration: "0.3s" }}>
        ...
        {/* Mobile nav toggle */}
        <button onClick={() => setMobileNav(!mobileNav)} className="absolute top-4 left-4 z-30 w-8 h-8 flex sm:hidden items-center justify-center text-dark-muted hover:text-dark-text transition-colors cursor-pointer">
